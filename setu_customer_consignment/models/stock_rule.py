...
class StockRule(models.Model):
    ...
    def _run_pull(self, procurements):
        ...
        for procurement, rule in procurements:
            ...
            if self._context.get('property_is_consignment') == True:
                move_values['location_id'] = self.env['sale.order'].search([('name', '=', move_values['origin'])]).partner_id.property_consignment_location_id.id
