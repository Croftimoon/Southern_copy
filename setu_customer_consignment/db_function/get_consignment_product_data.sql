DROP FUNCTION If EXISTS public.get_consignment_product_data(integer[], integer[], integer[], integer[], date, date);
CREATE OR REPLACE FUNCTION public.get_consignment_product_data(
...
BEGIN
    ...
    (
        ...
        group by  T.company_id, T.product_id
    )t_data;
